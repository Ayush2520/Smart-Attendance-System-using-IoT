...
def registration(faceid):
    ...
    assure_path_exists('D:/fall semester 2021-22/Digital Image Processing/project trials/Dataset/')
    # Start looping
    while (True):
...
def traindata():
    ...
    recognizer.write('D:/fall semester 2021-22/Digital Image Processing/project trials/trial.txt')
...
def recognizeImg():
    ...
    recognizer = cv2.face.LBPHFaceRecognizer_create();
    recognizer.read('D:/fall semester 2021-22/Digital Image Processing/project trials/trial.txt');
    id = 0;
    filename = 'filename';
    dict = {
        'item1': 1
